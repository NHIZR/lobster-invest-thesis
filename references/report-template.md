...
Full template for investment research memos. Referenced from SKILL.md.
...
- See references/data-sources.md for indicator details

## 🎭 Sentiment Pulse
- Social sentiment / Discussion heat / Institutional flow
- Sentiment-fundamental alignment check
